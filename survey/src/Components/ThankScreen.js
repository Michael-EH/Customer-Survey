...
function ThankScreen() {
  return (
    <div className='ThankDiv'>
        <h1 className='Hyper' data-value="Thank You For Participating">Thank You For Participating In Our Survey</h1>
        <p className="swift-up-text">We hope to see you again soon. Have a wonderful rest of your day</p>
        <img src={img7}/>
    </div>
  )
}
